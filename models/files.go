...
var FileWhere = struct {
	...
	Hash:       whereHelperstring{field: "\"files\".\"hash\""},
	LanguageID: whereHelperint{field: "\"files\".\"language_id\""},
...
var (
	fileAllColumns            = []string{"id", "hash", "language_id", "content", "created_at"}
	fileColumnsWithoutDefault = []string{"hash", "content"}
	fileColumnsWithDefault    = []string{"id", "language_id", "created_at"}
...
func (o *File) Language(mods ...qm.QueryMod) languageQuery {
...
func (fileL) LoadLanguage(ctx context.Context, e boil.ContextExecutor, singular bool, maybeFile interface{}, mods queries.Applicator) error {
	var slice []*File
	var object *File
...
// SetLanguage of the file to the related item.
// Sets o.R.Language to related.
// Adds o to related.R.File.
func (o *File) SetLanguage(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Language) error {
	var err error
	if insert {
